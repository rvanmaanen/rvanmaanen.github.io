...
*Update: Others, like Jeff Hollan, have been able to get am Azure Function working with Python. They're [running into other things](https://github.com/Azure/azure-functions-python-worker/issues/164), so my conclusion remains the same: it's preview for a reason.*
